...
import { DigitalNewData } from "../../Data";
    ...
    <section className="w-[full] max-w-[1800px] mt-12 border-t-2">
      <div className="flex flex-col gap-y-4 w-[95%] mx-auto mt-7">
        <div className="flex flex-row gap-x-4 mb-6">
          <h1 className="text-[36px] text-dark ">Digital New Releases</h1>
                  ...
                  <div className="w-[95%] mx-auto">
                    ...
                    <div className="mt-8">
                      <div className="w-[70px]">
                        <h2 className="  text-[12px] px-6 bg-[red] rounded-[20px] mb-2 text-white">
                          {data.tag}
                        </h2>
                      </div>
